...
#' )
#' ggplot3(d, aes(axis, value, color = model)) +
#'   geom_radar() +
#'   coord_polar() +
#'   theme_minimal()
#' @export
...
#' @return A [Layer] to add with `+`.
#' @examples
#' ggplot3(iris, aes(Sepal.Length, Species)) + geom_ridgeline()
#' @export
...
#'   n = c(400, 600, 150, 250)
#' )
#' ggplot3(d, aes(x = from, xend = to, y = n)) +
#'   geom_sankey() +
#'   theme_void()
#' @export
...
#' )
#' ggplot3(d, aes(size = revenue, label = region, color = region)) +
#'   geom_treemap() +
#'   theme_void()
#' @export
...
#'   to = c("B", "C", "C", "D", "E", "A")
#' )
#' ggplot3(d, aes(x = from, xend = to)) + geom_network() + theme_void()
#' @export
...
#'   n = c(5, 3, 7, 2)
#' )
#' ggplot3(d, aes(x = from, xend = to, y = n)) + geom_chord() + theme_void()
#' @export
...
#' )
#' ggplot3(d, aes(var, val, group = id, color = factor(id))) + geom_parallel()
#' @export
...
#' )
#' ggplot3(d, aes(year, rank, color = team)) +
...
#' )
#' ggplot3(d, aes(stage, n, color = stage)) + geom_funnel() + theme_void()
#' @export
...
#' )
#' ggplot3(d, aes(t, v, color = grp)) + geom_stream() + theme_minimal()
#' @export
...
#' ggplot3(d, aes(label = sets)) + geom_upset() + theme_void()
#' @export
