...
#
#   Ggplot3Plot  = data + mapping + [Layer] + [Scale] + Coord
...
#' Ggplot3Plot: the complete plot specification
#'
#' Built by [ggplot3()] and grown with `+`. Holds everything needed to
...
#' @return An S7 object of class `Ggplot3Plot`, as returned by [ggplot3()].
#' @export
Ggplot3Plot <- new_class("Ggplot3Plot", properties = list(
  data = class_any,
  mapping = class_any,
  layers = class_list,
  scales = class_list,
