...
#' ggplot3(d, aes(xmin = x1, xmax = x2, ymin = y1, ymax = y2)) + geom_rect()
#' @export
...
#' ggplot3(d, aes(x, y)) + geom_polygon()
#' @export
...
#' ggplot3(g, aes(x, y, color = z)) + geom_raster()
#' @export
...
#' @return A [Layer] to add with `+`.
#' @examples
#' ggplot3(cars, aes(speed, dist)) + geom_blank()
#' @export
...
#' ggplot3(d, aes(x, y, label = l)) + geom_label()
#' @export
...
#' ggplot3(d, aes(g, ymin = lo, ymax = hi)) + geom_linerange()
#' @export
...
#' ggplot3(d, aes(g, m, ymin = lo, ymax = hi)) + geom_crossbar()
#' @export
...
#' @examples
#' d <- data.frame(g = c("a", "b"), lo = c(1, 2), hi = c(4, 5))
#' ggplot3(d, aes(y = g, xmin = lo, xmax = hi)) + geom_errorbarh()
#' @export
...
#' @return A [Layer] to add with `+`.
#' @examples
#' ggplot3(cars, aes(speed, dist)) + geom_point() + geom_rug()
#' @export
...
#' ggplot3(d, aes(x, y, xend = xe, yend = ye)) + geom_curve()
#' @export
...
#' g$radius <- 0.4
#' ggplot3(g, aes(x, y, xend = angle, yend = radius)) + geom_spoke()
#' @export
...
#' @return A [Layer] to add with `+`.
#' @examples
#' ggplot3(cars, aes(speed)) + geom_freqpoly(bins = 8)
#' @export
...
#' @return A [Layer] to add with `+`.
#' @examples
#' ggplot3(data.frame(x = c(-3, 3)), aes(x)) +
